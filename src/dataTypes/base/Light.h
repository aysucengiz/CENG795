...
public:
    ...
    virtual Vec3r getNormal(Ray &ray) {return ray.dir;}
    virtual LightType getLightType();
    virtual Color getIrradianceAt(Vec3r n_surf, Ray& shadow_ray, const Vertex& intersection) const;
...
public:
    ...
    Vec3r getNormal(Ray &ray) override {return n;}
    AreaLight(uint32_t id, Vertex pos, Color intens, Vec3r n, real Size);
    Color getIrradianceAt(Vec3r n_surf, Ray& shadow_ray, const Vertex& intersection) const override;
...
public:
    ...
    Vec3r getNormal(Ray &ray) override {return dir;}
...
// TODO: çok can sıkıcı duruyor ben geçiyorum şimdilik
